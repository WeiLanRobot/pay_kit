...
class DefaultPayPluginConfig implements PayPluginConfig {
  ...
  void showToast(String message, {bool isTip = false, bool lengthLong = false}) {
    ...
    // 无 handler 时打印日志，业务层必须注入 showToastHandler
    debugPrint('[PayPlugin] Toast: $message');
  }
  ...
  void showLoading() {
    ...
    // 无 handler 时打印日志，业务层必须注入 showLoadingHandler
    debugPrint('[PayPlugin] showLoading: please inject showLoadingHandler');
  }
  ...
  void dismissLoading() {
    ...
    // 无 handler 时打印日志，业务层必须注入 dismissLoadingHandler
    debugPrint('[PayPlugin] dismissLoading: please inject dismissLoadingHandler');
  }
